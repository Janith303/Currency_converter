...
<head>
  ...
  <style>
    ...
    select, input {
      ...
      border-radius: 8px;
      background: rgba(255, 255, 255, 0.15); /* Transparent input fields */
      color: #fff;
      font-size: 1em;
      outline: none;
    ...
    button {
      width: 100%;
      padding: 12px;
      background: #1abc9c; /* Vibrant teal button */
      color: #fff;
      border: none;
      border-radius: 8px;
      font-size: 1.1em;
    ...
    th {
      background: #1abc9c; /* Teal header */
      font-weight: bold;
    }

    tr:nth-child(even) {
      background: rgba(255, 255, 255, 0.05); /* Subtle striping */
    }
